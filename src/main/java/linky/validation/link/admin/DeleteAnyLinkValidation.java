...
@Component
public class DeleteAnyLinkValidation implements Validation<DeleteAnyLink> {
	private final LinkDao linkDao;

	@Autowired
	public DeleteAnyLinkValidation(LinkDao linkDao) {
		this.linkDao = linkDao;
	}

	@Override
	public void validate(DeleteAnyLink command) {
